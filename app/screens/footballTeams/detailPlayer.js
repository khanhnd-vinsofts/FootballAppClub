            ...
            <View style={styles.container}>
                ...
                <View style={styles.layoutImage}>
                    <View style={styles.image}>
                        <Image source={require('../../assets/images/ronando.png')} style={{ width: '100%', height: '100%', borderRadius: 15 }} resizeMode="contain" />
                    </View>

                    <View style={styles.infoDetail}>

                        <View style={{ flex: 3, marginLeft: 20 }}>
                            <BaseText style={{ color: '#ffffff', fontWeight: "500", fontSize: 22, marginTop: 5 }}>Cristiano Ronaldo</BaseText>
                    ...
                    <View style={{ flexDirection: 'row', marginTop: 70, marginLeft: 35 }}>
                        ...
                        <TouchableHighlight
                            style={[styles.button, { backgroundColor: '#ffffff', borderWidth: 1, borderColor: '#0072FB' }]}
                        >
                            <Image
